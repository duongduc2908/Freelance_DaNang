...
cd ..
git clone https://github.com/PhiDCH/CRAFT-pytorch textSpotting/CRAFTpytorch\

git clone https://github.com/PhiDCH/text-recognition textSpotting/textRecognition\
