...
def load_model_1(model_path_recognition = 'textSpotting/textRecognition/best_accuracy.pth'):
    # Recognition
    opt = default_args(model_path_recognition)
    model_recognition = TextRecogInferer(opt)

    # Detection
    craft_detect = load_model('textSpotting/CRAFTpytorch/craft_mlt_25k.pth')
